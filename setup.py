...
setup(
    ...
    install_requires=['CLAM >= 3.1.4', 'FoLiA-tools'] #Ucto is also required but is an external dependency that setuptools can't handle, we specify it in codemeta-harvest.json for metadata harvesting purposes
)
